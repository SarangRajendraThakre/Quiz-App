...
const Header = () => {
  ...
  <span className='pr-[20px]'><svg xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 84 30" height="40px" width="120px">
  ...
  <IoIosColorPalette/>
    ...
    <button className='bg-[#F2F2F2] h-[38px] px-[16px] pb-[4px]  font-semibold mr-[8px] rounded-md  '>Exit</button>
